...
<?php
    $cnt = 0;
    $fp = fopen("news_data.csv", "r");
    $size = filesize("news_data.csv");
    $fval = file('news_data.csv', FILE_IGNORE_NEW_LINES);
?>
<html lang="ja">
<head>
...
<div id="slideshow" class="slideshow">
        <img src="images/img_01.jpg" width="1263" height="686" alt="">
        <img src="images/img_14.jpg" width="1263" height="686" alt="">
        <img src="images/img_15.jpg" width="1263" height="686" alt="">
</div>
...
<dl id="acMenu">
    ...
    foreach ($data as $news_data) :
            list($year,$title,$writ) = explode(",", $news_data);
            $write = str_replace("\t", "\n", $writ);
        ?>
<dt><?php echo $year,"　-　",$title; ?></dt>
<dd><?php echo nl2br($write); ?></dd>

    <?php endforeach;
    echo '</dl>';
} else {
    echo '<p class="not_news">現在投稿はありません</p>';
}?>
            </div>
        </div>
    </div>
